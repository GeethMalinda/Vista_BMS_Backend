...
import lk.vista.book.entity.Role;
import lk.vista.book.entity.User;
import lk.vista.book.repo.RoleRepository;
import lk.vista.book.repo.UserRepository;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Autowired
    public UserServiceImpl(UserRepository userRepo, PasswordEncoder passwordEncoder, RoleRepository roleRepository) {
